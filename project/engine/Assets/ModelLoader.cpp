...
std::vector<AnimationHandle> Asset::ModelLoader::ProcessAnimation(const aiScene* scene) {
...
SkeletonHandle Asset::ModelLoader::ProcessSkeleton(const Node& rootNode,Mesh& mesh) {
	Skeleton skeleton{};
	skeleton.root = CreateJoint(rootNode, {}, skeleton.joints);
