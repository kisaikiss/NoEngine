...
Matrix4x4::Matrix4x4(const Matrix3x3& matrix3x3) {
	m[0][0] = matrix3x3.m[0][0];
	m[0][1] = matrix3x3.m[0][1];
	m[0][2] = matrix3x3.m[0][2];
	m[0][3] = 0.0f;

	m[1][0] = matrix3x3.m[1][0];
	m[1][1] = matrix3x3.m[1][1];
	m[1][2] = matrix3x3.m[1][2];
	m[1][3] = 0.0f;

	m[2][0] = matrix3x3.m[2][0];
	m[2][1] = matrix3x3.m[2][1];
	m[2][2] = matrix3x3.m[2][2];
	m[2][3] = 0.0f;
