    ...
    if (timer_ > generateTime_) {
        ...
        for (uint32_t i = 0; i < generateCount; i++) {
            ...
            if (isCarrot_) {
                ...
                NoEngine::ModelLoader::LoadModel("carrot", "resources/game/td_2304/Model/normalVegetable/carrot.obj", model, animationComp);
                m->materials = NoEngine::ModelLoader::GetMaterial("carrot");

            } else {
                registry.AddComponent<WhiteRadishTag>(entity);
                NoEngine::ModelLoader::LoadModel("white", "resources/game/td_2304/Model/normalVegetable/pot.obj", model, animationComp);
                m->materials = NoEngine::ModelLoader::GetMaterial("white");
            }
