...
void CarrotControlSystem::Shoot(No::Registry& registry, No::TransformComponent* enemyTransform) {
	...
	NoEngine::ModelLoader::LoadModel("flame2", "resources/game/td_2304/Model/flame2/flame2.obj", model, animationComp);

	auto m = registry.AddComponent<No::MaterialComponent>(entity);
	m->materials = NoEngine::ModelLoader::GetMaterial("flame2");
