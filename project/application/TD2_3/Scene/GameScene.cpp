...
void GameScene::InitVaus(No::Registry& registry)
{
    ...
    No::ModelLoader::LoadModel("paddleMiddle", "resources/game/td_2304/Model/paddle/middle1.obj", model);

    auto* m = registry.AddComponent<No::MaterialComponent>(vausEntity);
    m->materials = No::ModelLoader::GetMaterial("paddleMiddle");
    m->color = 0xA82C57ff;
    m->drawOutline = true;
...
void GameScene::InitRing(No::Registry& registry)
{
    ...
    No::ModelLoader::LoadModel("circle", "resources/game/td_2304/Model/circle/circle.obj", model);

    auto m = registry.AddComponent<No::MaterialComponent>(ringEntity);
    m->materials = No::ModelLoader::GetMaterial("circle");
    m->color.a = 0.7f;
    m->color.b = 0.5f;
...
void GameScene::InitBall(No::Registry& registry)
{
    ...
    No::ModelLoader::LoadModel("ball", "resources/game/td_2304/Model/ball/ball.obj", model);

    auto m = registry.AddComponent<No::MaterialComponent>(ballEntity);
    m->materials = No::ModelLoader::GetMaterial("ball");
...
void GameScene::InitEnemy(No::Registry& registry)
{
    for (int i = 0; i < 5; ++i)
    {
        ...
        No::ModelLoader::LoadModel(enemyResources_.modelName, enemyResources_.modelPath, model, animationComp);

        auto m = registry.AddComponent<No::MaterialComponent>(enemyEntity);
        m->materials = No::ModelLoader::GetMaterial("bat");
...
void GameScene::InitBatGirl(No::Registry& registry)
{
    ...
    No::ModelLoader::LoadModel("batGirl", "resources/game/td_2304/Model/batGirl/batGirl.gltf", model, animationComp);
    ...
    m->materials = No::ModelLoader::GetMaterial("batGirl");
...
void GameScene::InitPlayerGirl(No::Registry& registry)
{
    ...
    No::ModelLoader::LoadModel("playerGirl", "resources/game/td_2304/Model/playerGirl/playerGirl.gltf", model, animationComp);

    transform->translate = { -6.1f,-14.55f,-8.5f };
    transform->rotation.FromAxisAngle(No::Vector3::UP, 3.14f);

    auto m = registry.AddComponent<No::MaterialComponent>(playerGirlEntity);
    m->materials = No::ModelLoader::GetMaterial("playerGirl");
...
void GameScene::InitChef(No::Registry& registry)
{
    ...
    No::ModelLoader::LoadModel("chef", "resources/game/td_2304/Model/man/man.gltf", model, animationComp);

    transform->translate = { 3.00f,0.0f,0.0f };

    auto m = registry.AddComponent<No::MaterialComponent>(chefEntity);
    m->materials = No::ModelLoader::GetMaterial("chef");
...
void GameScene::ModelLoad() {
    No::ModelLoader::LoadModel("batBoss", "resources/game/td_2304/Model/batBoss/batBoss.gltf");
    No::ModelLoader::LoadModel("potBoss", "resources/game/td_2304/Model/pot/pot.gltf");
}
